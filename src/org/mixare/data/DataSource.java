...
public class DataSource {
	...
	public static String customizedURL="file://sdcard/test2.php";

	public static Bitmap twitterIcon;
	public static Bitmap buzzIcon;
	public static Bitmap building;
	...
	public static void createIcons(Resources res) {
		...
		//building=BitmapFactory.decodeResource(res, R.drawable.home);
		building=BitmapFactory.decodeResource(res, R.drawable.ar_poi_1);
	}
	...
	public static int getColor(DATASOURCE datasource) {
		...
		switch(datasource) {
			...
			case OWNURL:    ret=Color.RED; break; //bogus
